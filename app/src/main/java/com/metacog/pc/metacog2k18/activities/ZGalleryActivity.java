package com.metacog.pc.metacog2k18.activities;
...
import com.metacog.pc.metacog2k18.R;
...
public class ZGalleryActivity extends BaseActivity {
    ...
    protected void afterInflation() {
        // init layouts
        mainLayout = (RelativeLayout) findViewById(com.mzelzoghbi.zgallery.R.id.mainLayout);
        mViewPager = (CustomViewPager) findViewById(com.mzelzoghbi.zgallery.R.id.pager);
        imagesHorizontalList = (RecyclerView) findViewById(com.mzelzoghbi.zgallery.R.id.imagesHorizontalList);
