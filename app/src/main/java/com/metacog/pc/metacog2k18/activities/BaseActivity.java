...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mToolbar = (Toolbar) findViewById(com.mzelzoghbi.zgallery.R.id.toolbar);
        ...
        if (getSupportActionBar() == null) {
            ...
            if (toolbarTitleColor == ZColor.BLACK) {
                ...
                getSupportActionBar().setHomeAsUpIndicator(com.mzelzoghbi.zgallery.R.drawable.ic_arrow_back_black);
            } else {
                mToolbar.setTitleTextColor(ContextCompat.getColor(this, android.R.color.white));
                getSupportActionBar().setHomeAsUpIndicator(com.mzelzoghbi.zgallery.R.drawable.ic_arrow_back_white);
            }
